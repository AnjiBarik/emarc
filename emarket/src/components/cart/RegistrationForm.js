...
//     invalidNameMessage: "Nickname must contain at least one Latin letter"
//   }), []);
...
//                   {(validationPatterns.invalidName(formData.Name) || !formData.Name )&& <p className="error-message">{validationPatterns.invalidNameMessage}</p>}
