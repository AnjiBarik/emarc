...
//       const lang = await iconPath('lang.png', 'lang');
//       const dark = await iconPath('dark.png', 'dark');
//       const light = await iconPath('light.png', 'light');
//       const email = await iconPath('email.png', 'email');
//       const inst = await iconPath('inst.png', 'inst');
//       const face = await iconPath('face.png', 'face');
//       const telegram = await iconPath('telegram.png', 'telegram');
//       const fone = await iconPath('fone.png', 'fone');
//       const tik = await iconPath('tik.png', 'tik');
//       const you = await iconPath('you.png', 'you');
//       const card = await iconPath('card.png', 'card');
//       const location = await iconPath('location.png', 'location');
//       const about = await iconPath('about.png', 'about');
//       const loading3 = await iconPath('loading3.png', 'loading3');
//       const loading2 = await iconPath('loading2.png', 'loading2');
//       const loading1 = await iconPath('loading1.png', 'loading1');
//       const ava = await iconPath('user.png', 'ava');
//       const carticon = await iconPath('carticon.png', 'carticon');
//       const home = await iconPath('home.png', 'home');
//       const search = await iconPath('search.png', 'search');
//       const category = await iconPath('category.png', 'category');
//       const notFound = await iconPath('imageNotFound.png', 'notFound');
//       const burger = await iconPath('burger.png', 'burger');
//       const cancel = await iconPath('cancel.png', 'cancel');
//       const upmenu = await iconPath('upmenu.png', 'upmenu');
//       const filter = await iconPath('filter.png', 'filter');
//       const filterremove = await iconPath('filterremove.png', 'filterremove');
//       const discont = await iconPath('discont.png', 'discont');
//       const newcart = await iconPath('new.png', 'newcart');
//       const popular = await iconPath('popular.png', 'popular');
//       const down_sort = await iconPath('down_sort.png', 'down_sort');
//       const up_sort = await iconPath('up_sort.png', 'up_sort');
//       const list_icon = await iconPath('list_icon.png', 'list_icon');
//       const comfy_icon = await iconPath('comfy_icon.png', 'comfy_icon');
//       const cartadd = await iconPath('cartaddicon.png', 'cartadd');
//       const cartupl = await iconPath('uploadcarticon.png', 'cartupl');
//       const buynow = await iconPath('buynow.png', 'buynow');
//       const up = await iconPath('up.png', 'up');
//       const cart = await iconPath('cart.svg', 'cart');
//       const back = await iconPath('back.png', 'back');
//       const upload = await iconPath('orderfailure.png', 'upload');
//       const check = await iconPath('check.png', 'check');
//       const favorite = await iconPath('favorite.png', 'favorite');
//       const addfavorite = await iconPath('addfavorite.png', 'addfavorite');
//       const call = await iconPath('call.png', 'call');
//       const user = await iconPath('user.png', 'user');
//       const chat = await iconPath('chat.png', 'chat');
//       const addressIcon = await iconPath('location.png', 'addressIcon');
//       const enter = await iconPath('enter.png', 'enter');
//       const useradd = await iconPath('useradd.png', 'useradd');
//       const logout = await iconPath('logout.png', 'logout');
//       const userok = await iconPath('userok.png', 'userok');
//       const nickname = await iconPath('nickname.png', 'nickname');
//       const password = await iconPath('password.png', 'password');
//       const info = await iconPath('info.png', 'info');
//       const zoomout = await iconPath('zoomout.png', 'zoomout');
//       const zoomin = await iconPath('zoomin.png', 'zoomin');
...
//     // const defaultUrl = initialIcons[iconName.split('.')[0]];
//     // console.log(iconName.split('.')[0])
